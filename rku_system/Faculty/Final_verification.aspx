<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/Dashboard.Master" AutoEventWireup="true" CodeBehind="Final_verification.aspx.cs" Inherits="rku_system.Faculty.Final_verification" %>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:Button class="btn btn-info mx-4" ID="btn_verify" runat="server" Text="Verify" OnClick="btn_verify_Click"></asp:Button>
