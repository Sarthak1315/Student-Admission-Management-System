<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Desboard.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="rku_system.Admin_portal.WebForm1" %>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
      <div class="card">
        <div class="card-header p-3 pt-2">
          ...
          <div class="text-end pt-1">
            <p class="text-sm mb-0 text-capitalize">Total  Registered Student</p>
    ...
    <div class="col-xl-3 col-sm-6">
      <div class="card">
        <div class="card-header p-3 pt-2">
          ...
          <div class="text-end pt-1">
            <p class="text-sm mb-0 text-capitalize">Total Confirm Student</p>
